  ...
  export default {
    ...
    methods: {
      telLogin() {
        ...
        const vali = new validate(this);
        if (!vali.rightTel().state) {
          this.tips = vali.rightTel().message;
          return;
        }
        if (!vali.rightPwd().state) {
          this.tips = vali.rightPwd().message;
          return;
        }
